...
<pre>
    ...
    */
    ...
    typedef typename adj_graph::reverse_iterator reverse_iterator;
    typedef typename adj_graph::const_reverse_iterator const_reverse_iterator;
    ...
    reverse_iterator rbegin() { return G_.rbegin(); }
    const_reverse_iterator rbegin() const { return G_.rbegin(); }
    reverse_iterator rend() { return G_.rend(); }
    const_reverse_iterator rend() const { return G_.rend(); }
